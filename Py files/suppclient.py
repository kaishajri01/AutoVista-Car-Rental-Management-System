...
# Form implementation generated from reading ui file 'suppclient.ui'
#
...
class Ui_Dialog(object):
    ...
    def suppclien(self):
        ...
        self.Agence.ListeClient.suprrimer_client(cin)
        self.showDialog("Suppression Terminé !",True)
        self.lineEdit.setText("")
        return
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(-16, -5, 1421, 851))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/pic/b2.jpg"))
        self.label.setScaledContents(True)
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(Dialog)
        self.label_2.setGeometry(QtCore.QRect(560, 30, 221, 71))
        font = QtGui.QFont()
...
"color:white;")
        ...
        self.lineEdit.setGeometry(QtCore.QRect(510, 260, 331, 31))
        font = QtGui.QFont()
...
"")
        ...
        self.pushButton.setGeometry(QtCore.QRect(530, 490, 301, 41))
        font = QtGui.QFont()
...
"}")
        ...
        self.pushButton.clicked.connect(self.suppclien)
